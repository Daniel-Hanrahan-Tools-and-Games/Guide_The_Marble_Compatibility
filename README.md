...
<p>Controls: arrow keys for directions.</p>
...
<ol>
  <li>Type this in your terminal: cd /"Path To Game Folder"/Guide_The_Marble_Compatibility</li>
  <li>Type this in terminal: g++ Guide_The_Marble_Compatibility.cpp -o Guide_The_Marble_Compatibility     -I./lua542Linux     ./lua542Linux/liblua54.a     -lraylib -lGL -lm -lpthread -ldl -lrt -lX11
</li>
...
<ul>
  <li>To load a mod file, the mod file needs to be in the game directory and needs to be called Guide_The_Marble_Compatibility_Mod.lua in Guide_The_Marble_Compatibility_Mod folder</li>
...
<a href="https://github.com/Daniel-Hanrahan-Tools-and-Games/Guide_The_Marble_Compatibility_Mod">Example Mod Repository Page</a>

<a href="https://github.com/Daniel-Hanrahan-Tools-and-Games/Guide_The_Marble">Original Version Repository Page</a>

<a href="https://daniel-hanrahan-tools-and-games.github.io/Guide_The_Marble/">Original Version ReadMe Page</a>
